...
export const StudioUploadProgress: React.FC<StudioUploadProgressProps> = ({
  ...
  return (
    <div className="max-w-md w-full bg-[#1A1B1D] border border-[#2E3033] rounded-2xl p-8 space-y-6 shadow-2xl text-center animate-fade">
      ...
      <div className="space-y-3 text-left">
        <div className="space-y-1">
          <div className="flex justify-between text-xs font-mono text-[#8B8D90]">
            <span>Host (Alex Rivers) 1080p ProRes</span>
            <span>{hostUploadProgress}%</span>
          </div>
          <div className="w-full h-1 bg-[#2E3033] rounded-full overflow-hidden">
            <div
